...
# NebulaOps v20.2 — Terraform DevOps Control Plane

NebulaOps v20.2 è un progetto portfolio Cloud/DevOps local-first con Angular, microservizi, Docker Compose, Kubernetes,
...
- Documentazione v20.2 aggiornata.
...
## v20.2 DevSecOps Module

La v20.2 aggiunge i tab `SECURITY`, `COMPLIANCE` e `VULNERABILITIES` con radar animation, threat map, critical alerts,
...
## v20.2 Documentation & diagrams patch
...
## v20.2 Corrected Build Package

This package includes the DevSecOps module and the v20.2 stabilization patch:
...
- Backend Maven versions aligned to `20.2.0`.
- Docs, Markdown files, and SVG labels aligned to v20.2.
...
## v20.2 Corrected - Home Feature Launcher
...
## v20.2 Live Runtime Upgrade

La release v20.2 aggiunge un livello dinamico sopra i moduli enterprise della v19.x:
...
## v20.2.3 NPM Build Fix

Frontend Docker build hardened: Node 20.21.1, stale lockfile removed, npm install fallback for Angular dependencies. See V20_2_3_NPM_FIX.md.
