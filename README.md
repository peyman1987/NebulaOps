...
# NebulaOps v20.3 — Terraform DevOps Control Plane

NebulaOps v20.3 è un progetto portfolio Cloud/DevOps local-first con Angular, microservizi, Docker Compose, Kubernetes,
...
- Documentazione v20.3 aggiornata.
...
## v20.3 DevSecOps Module

La v20.3 aggiunge i tab `SECURITY`, `COMPLIANCE` e `VULNERABILITIES` con radar animation, threat map, critical alerts,
...
## v20.3 Documentation & diagrams patch
...
## v20.3 Corrected Build Package

This package includes the DevSecOps module and the v20.3 stabilization patch:
...
- Backend Maven versions aligned to `20.3.0`.
- Docs, Markdown files, and SVG labels aligned to v20.3.
...
## v20.3 Live Runtime Upgrade

La release v20.3 aggiunge un livello dinamico sopra i moduli enterprise della v19.x:
...
## v20.3.3 NPM Build Fix

Frontend Docker build hardened: Node 20.31.1, stale lockfile removed, npm install fallback for Angular dependencies. See
V20_2_3_NPM_FIX.md.
