...
NebulaOps v23.3 uses a same-origin browser architecture. The only supported browser entry point is `http://nebulaops.localhost`.
...
![NebulaOps v23.3 runtime](docs/architecture-animated.svg)
