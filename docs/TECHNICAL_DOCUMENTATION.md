...
This document describes the current NebulaOps v22.3 local runtime. The platform is designed around a single browser-facing origin, `http://nebulaops.localhost`, with the frontend Nginx container serving static shell/MFE files and proxying API and platform routes into the Docker network.
...
![Reverse proxy runtime](diagrams/nebulaops-v22-3-reverse-proxy-runtime.svg)
