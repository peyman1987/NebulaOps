# NebulaOps v19.4 — CI/CD Pipeline Designer

v19.4 introduces a portfolio-grade CI/CD Pipeline Designer with a visual drag-and-drop canvas and backend contract for
...
- `GET /api/pipeline-engine/template` — returns default v19.4 stage map, GitLab YAML and ArgoCD metadata.
