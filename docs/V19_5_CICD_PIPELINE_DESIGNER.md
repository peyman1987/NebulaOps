# NebulaOps v20.2 — CI/CD Pipeline Designer

v20.2 introduces a portfolio-grade CI/CD Pipeline Designer with a visual drag-and-drop canvas and backend contract for
...
- `GET /api/pipeline-engine/template` — returns default v20.2 stage map, GitLab YAML and ArgoCD metadata.
