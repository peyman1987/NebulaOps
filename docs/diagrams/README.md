...
| Diagram | Purpose |
| --- | --- |
| `runtime-architecture.svg` | Runtime service topology |
| `gitlab-argocd-flow.svg` | Optional GitLab CI and Argo CD delivery flow |
| `messaging-cache-flow.svg` | MongoDB, RabbitMQ and Redis data flow |
...
| `nebulaops-v22-5-reverse-proxy-runtime.svg` | Frontend Nginx same-origin runtime |
