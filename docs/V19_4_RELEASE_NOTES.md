...
- New v19.5 docs for CI/CD Designer and INFRA Hub.

## Updated

- Frontend branding and local storage keys moved from v19.3 to v19.5.
...
- Docker Compose image names and project names updated to `nebulaops-v19-5`.
