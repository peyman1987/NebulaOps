...
NebulaOps v19.3 is a single-machine DevOps control plane designed for WSL Ubuntu or native Linux without Docker Desktop.
...
- Kubernetes: kind cluster named `nebulaops-v19-3`.
- Compose project: `nebulaops-v19-3`.
