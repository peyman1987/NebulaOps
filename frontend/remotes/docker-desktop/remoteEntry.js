...
(function nebulaopsLiveRemote(){
  ...
  "config": {
    "endpoints": [
      {
        "label": "Docker engine status",
        "url": "/api/runtime/docker/status",
        "kind": "docker-status"
      },
      {
        "label": "Compose projects",
        "url": "/api/runtime/docker/projects",
        "kind": "docker-project"
      },
      {
        "label": "Containers",
      ...
      {
        "label": "Images",
        "url": "/api/runtime/docker/images",
        "kind": "image"
      },
      {
        "label": "Volumes",
        "url": "/api/runtime/docker/volumes",
        "kind": "volume"
      },
      {
        "label": "Networks",
        "url": "/api/runtime/docker/networks",
        "kind": "network"
      },
      {
        "label": "Runtime stats",
        "url": "/api/runtime/docker/stats",
        "kind": "stats"
      },
      {
        "label": "Docker diagnostics",
        "url": "/api/runtime/docker/diagnostics",
        "kind": "docker-diagnostics"
      },
      {
        "label": "Resource pressure",
        "url": "/api/runtime/docker/resource-pressure",
        "kind": "docker-resource-pressure",
        "itemsPath": "items"
      },
      {
        "label": "Project risks",
        "url": "/api/runtime/docker/project-risks",
        "kind": "docker-project-risk",
        "itemsPath": "items"
      },
      {
        "label": "Build cache",
        "url": "/api/runtime/docker/build-cache",
        "kind": "docker-build-cache",
        "itemsPath": "items"
      },
      {
        "label": "Volume usage",
        "url": "/api/runtime/docker/volume-usage",
        "kind": "docker-volume-usage",
        "itemsPath": "items"
      },
      {
        "label": "Network exposure",
        "url": "/api/runtime/docker/network-exposure",
        "kind": "docker-network-exposure",
        "itemsPath": "items"
      },
      {
        "label": "Restart policy audit",
        "url": "/api/runtime/docker/restart-policy-audit",
        "kind": "docker-restart-policy",
        "itemsPath": "items"
      },
      {
        "label": "Environment risk audit",
        "url": "/api/runtime/docker/environment-risk-audit",
        "kind": "docker-environment-risk",
        "itemsPath": "items"
      },
      {
        "label": "Mount risk audit",
        "url": "/api/runtime/docker/mount-risk-audit",
        "kind": "docker-mount-risk",
        "itemsPath": "items"
      },
      {
        "label": "Container security audit",
        "url": "/api/runtime/docker/container-security-audit",
        "kind": "docker-container-security",
        "itemsPath": "items"
      },
      {
        "label": "Image hygiene audit",
        "url": "/api/runtime/docker/image-hygiene-audit",
        "kind": "docker-image-hygiene",
        "itemsPath": "items"
      },
      {
        "label": "Network inventory",
        "url": "/api/runtime/docker/network-inventory",
        "kind": "docker-network-inventory",
        "itemsPath": "items"
      },
      {
        "label": "Unused resource candidates",
        "url": "/api/runtime/docker/unused-resource-candidates",
        "kind": "docker-unused-resource-candidate",
        "itemsPath": "items"
      },
      {
        "label": "Published port conflicts",
        "url": "/api/runtime/docker/port-conflicts",
        "kind": "docker-port-conflict"
      },
      {
        "label": "Docker topology",
        "url": "/api/runtime/docker/topology",
        "kind": "docker-topology",
        "itemsPath": "nodes"
      },
      {
        "label": "Prune preview",
        "url": "/api/runtime/docker/prune/preview",
        "kind": "prune-preview"
      },
      {
        "label": "Docker system info",
        "url": "/api/runtime/docker/system/info",
        "kind": "system-info",
        "itemsPath": "items"
      },
      {
        "label": "Docker version",
        "url": "/api/runtime/docker/system/version",
        "kind": "system-version",
        "itemsPath": "items"
      },
      {
        "label": "Project health report",
        "url": "/api/runtime/docker/projects/nebulaops-v23-3/health-report",
        "kind": "docker-project-health",
        "itemsPath": "items"
      },
      {
        "label": "Project failure analysis",
        "url": "/api/runtime/docker/projects/nebulaops-v23-3/failure-analysis",
        "kind": "docker-project-failure-analysis",
        "itemsPath": "items"
      },
      {
        "label": "Project startup order",
        "url": "/api/runtime/docker/projects/nebulaops-v23-3/startup-order",
        "kind": "docker-project-startup-order",
        "itemsPath": "items"
      },
      {
        "label": "Project dependency map",
        "url": "/api/runtime/docker/projects/nebulaops-v23-3/dependency-map",
        "kind": "docker-project-dependency-map",
        "itemsPath": "nodes"
      },
      {
        "label": "Project log analysis",
        "url": "/api/runtime/docker/projects/nebulaops-v23-3/log-analysis?tail=500",
        "kind": "docker-project-log-analysis",
        "itemsPath": "items"
      },
      {
        "label": "Docker operations timeline",
        "url": "/api/runtime/docker/timeline?project=nebulaops-v23-3&windowSeconds=3600",
        "kind": "docker-timeline",
        "itemsPath": "items"
      },
      {
        "label": "Docker events",
        "url": "/api/runtime/docker/events",
        "kind": "event"
      },
      {
        "label": "System disk usage",
        "url": "/api/runtime/docker/system/df",
        "kind": "system-df"
      }
    ]
  }
