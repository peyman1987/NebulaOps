...
export class AppComponent implements OnInit, OnDestroy {
    ...
    tabIcon(tab: string): SafeHtml {
        const icons: Record<string, string> = {
            OVERVIEW: `<svg viewBox="0 0 64 64"><path d="M8 32 32 12l24 20"/><path d="M16 30v24h12V40h8v14h12V30"/></svg>`,
            TASKS: `<svg viewBox="0 0 64 64"><path d="M24 17h30M24 32h30M24 47h30"/><circle cx="12" cy="17" r="3"/><circle cx="12" cy="32" r="3"/><circle cx="12" cy="47" r="3"/></svg>`,
            DOCKER: `<svg viewBox="0 0 64 64"><rect x="10" y="29" width="8" height="7" rx="1"/><rect x="20" y="29" width="8" height="7" rx="1"/><rect x="30" y="29" width="8" height="7" rx="1"/><rect x="20" y="20" width="8" height="7" rx="1"/><rect x="40" y="29" width="8" height="7" rx="1"/><path d="M8 39h42c-.9 9.8-8.4 15-19.4 15H23C13 54 7.8 48.9 8 39Z"/><path d="M50 37c4-1 6-3.2 6.7-6.8 3 2.2 3.2 7.2-.5 10.4-1.7 1.5-3.8 2.3-6.2 2.4Z"/></svg>`,
            KUBERNETES: `<svg viewBox="0 0 64 64"><path d="M32 5 55 18v28L32 59 9 46V18Z"/><circle cx="32" cy="32" r="6"/><path d="M32 13v14M32 37v14M13 32h14M37 32h14M18.5 18.5l9.8 9.8M35.7 35.7l9.8 9.8M45.5 18.5l-9.8 9.8M28.3 35.7l-9.8 9.8"/></svg>`,
            HELM: `<svg viewBox="0 0 64 64"><circle cx="32" cy="32" r="20"/><circle cx="32" cy="32" r="7"/><path d="M32 5v13M32 46v13M5 32h13M46 32h13M13 13l9 9M42 42l9 9M51 13l-9 9M22 42l-9 9"/></svg>`,
            GRAFANA: `<svg viewBox="0 0 64 64"><path d="M35 10c-13 0-23 9.6-23 22 0 10.8 8.6 19.8 19.2 19.8 9.2 0 16.4-6.8 16.4-15.1 0-7-5.4-12.4-12-12.4-5.3 0-9.5 3.8-9.5 8.5 0 3.8 3 6.8 6.9 6.8 2.9 0 5.2-2 5.2-4.7 0-2-1.5-3.5-3.6-3.5"/><path d="M45 13l6-5 1 8 7 3-7 3-2 7-5-6-8 1 4-7Z"/></svg>`,
            OBSERVABILITY: `<svg viewBox="0 0 64 64"><path d="M10 42 23 29l10 8 19-22"/><path d="M10 52h44"/><circle cx="23" cy="29" r="3"/><circle cx="33" cy="37" r="3"/><circle cx="52" cy="15" r="3"/></svg>`,
            CICD: `<svg viewBox="0 0 64 64"><path d="M15 22h28l-6-6M43 22l-6 6M49 42H21l6 6M21 42l6-6"/><path d="M13 42c-5-8-2-20 8-25M51 22c5 8 2 20-8 25"/></svg>`,
            SECURITY: `<svg viewBox="0 0 64 64"><path d="M32 6 52 14v15c0 14-8.4 24-20 29C20.4 53 12 43 12 29V14Z"/><path d="m23 32 6 6 13-16"/></svg>`,
            INFRA: `<svg viewBox="0 0 64 64"><rect x="12" y="12" width="40" height="12" rx="3"/><rect x="12" y="28" width="40" height="12" rx="3"/><rect x="12" y="44" width="40" height="12" rx="3"/><circle cx="21" cy="18" r="2"/><circle cx="21" cy="34" r="2"/><circle cx="21" cy="50" r="2"/></svg>`
        };
        return this.sanitizer.bypassSecurityTrustHtml(icons[tab] || icons.OVERVIEW);
    }
