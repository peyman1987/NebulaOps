# NebulaOps v24.1 micro frontend architecture

v24.1 uses an Angular host shell with a persistent side menu and remote micro frontends loaded through `remoteEntry.js`.
