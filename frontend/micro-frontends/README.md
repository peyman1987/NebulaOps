# NebulaOps v22.3 micro frontend architecture

La v22.3 usa una shell host Angular con menu laterale persistente e micro frontend remoti caricati tramite `remoteEntry.js`.
