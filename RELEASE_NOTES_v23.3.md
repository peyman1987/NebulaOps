# NebulaOps v23.3 Release Notes

NebulaOps v23.3 is a runtime-stability, compact-UI and live-only operations release.

## Highlights

- Full release identifier alignment to `v23.3` / `23.3.0`.
- Docker image naming updated to the `nebulaops-v23-3-*` namespace.
...
- Re-ran live-only runtime verification and v23.3 static preflight.

## Docker/OpenLens Troubleshooting & Root Cause Upgrade

Added within v23.3 without changing the public release number.
