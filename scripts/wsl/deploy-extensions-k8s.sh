#!/usr/bin/env bash
# NebulaOps v23.3 — Build and deploy all platform extensions directly to Kubernetes.
...
LOCAL_REGISTRY_CONTAINER="${NEBULAOPS_LOCAL_REGISTRY_CONTAINER:-nebulaops-v23-3-registry}"
...
image_for() {
  case "$1" in
    apiforge) echo "nebulaops-v23-3-apiforge:latest" ;;
    kubebridge) echo "nebulaops-v23-3-kubebridge:latest" ;;
    runbook-center) echo "nebulaops-v23-3-runbook-center:latest" ;;
    extension-registry) echo "nebulaops-v23-3-extension-registry:latest" ;;
    contract-hub) echo "nebulaops-v23-3-contract-hub:latest" ;;
    eventops-center) echo "nebulaops-v23-3-eventops-center:latest" ;;
    observability-lens) echo "nebulaops-v23-3-observability-lens:latest" ;;
    gitops-center) echo "nebulaops-v23-3-gitops-center:latest" ;;
    secrets-config-center) echo "nebulaops-v23-3-secrets-config-center:latest" ;;
    slo-center) echo "nebulaops-v23-3-slo-center:latest" ;;
    backup-recovery-center) echo "nebulaops-v23-3-backup-recovery-center:latest" ;;
    *) return 1 ;;
  esac
}
