#!/usr/bin/env bash
# NebulaOps v23.4 — Docker Desktop/OpenLens E2E smoke.
...
say "▶ NebulaOps v23.4 Docker Desktop/OpenLens smoke"
...
NEBULAOPS_UI_E2E_ROUTES="/remotes/docker-desktop/,/remotes/openlens-kubernetes/" \
  node "$ROOT_DIR/scripts/wsl/tools/e2e-ui-console-check-v23.4.mjs"
...
say "\nNebulaOps v23.4 Docker Desktop/OpenLens smoke OK"
