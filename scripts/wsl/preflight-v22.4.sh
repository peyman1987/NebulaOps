...
bash "$ROOT_DIR/scripts/wsl/verify-v22.4-real-data-mode.sh"
bash "$ROOT_DIR/scripts/wsl/verify-v22.4-governance-real-data.sh"
bash "$ROOT_DIR/scripts/wsl/verify-v22.4-progressive-delivery-real-data.sh"
