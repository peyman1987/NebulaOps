#!/usr/bin/env bash
# Rebuild the v22.4 dual-JWT authentication bridge.
...
log_ok "v22.4 auth token bridge repaired"
echo "Open http://nebulaops.localhost/?v=v22.4.8-dual-jwt-auth-bridge and run Ctrl+Shift+R."
