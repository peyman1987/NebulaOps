...
[[ -f frontend/src/assets/nebulaops-density-v23-4.css ]] || fail "source density stylesheet missing"
[[ -f frontend/dist/nebulaops/browser/assets/nebulaops-density-v23-4.css ]] || fail "dist density stylesheet missing"
grep -q 'nebulaops-density-v23-4.css' frontend/src/index.html || fail "source index does not load density stylesheet"
grep -q 'nebulaops-density-v23-4.css' frontend/dist/nebulaops/browser/index.html || fail "dist index does not load density stylesheet"
ok "shell density stylesheet is present and loaded"

grep -R 'v23.4 Priority 7 density mode' frontend/tools/live-only-remote.template.js frontend/remotes/*/remoteEntry.js >/dev/null || fail "remote density marker missing"
...
echo "NebulaOps v23.4 UI density smoke test passed."
