#!/usr/bin/env bash
# NebulaOps v24.1 — async Extension Control Plane E2E smoke.
...
say "▶ NebulaOps v24.1 extensions E2E smoke"
...
if [[ "${NEBULAOPS_SKIP_EXTENSION_START_SMOKE:-0}" == "1" ]]; then
  ...
  say "NebulaOps v24.1 extensions smoke OK"
  exit 0
fi
...
bash -n "$ROOT_DIR/scripts/wsl/smoke-extension-async-control-plane-v24.1.sh"
ok "legacy async extension smoke script syntax is valid"

say "\nNebulaOps v24.1 extensions E2E smoke OK"
