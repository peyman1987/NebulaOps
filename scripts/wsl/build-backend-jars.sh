#!/usr/bin/env bash
# NebulaOps v23.1 reliable backend build.
...
if [ -f "$ROOT_DIR/scripts/wsl/repair-v23.1-docker-context.sh" ]; then
  "$ROOT_DIR/scripts/wsl/repair-v23.1-docker-context.sh" >/dev/null
fi
