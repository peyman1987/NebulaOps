#!/usr/bin/env bash
# NebulaOps v22.5 reliable backend build.
...
if [ -f "$ROOT_DIR/scripts/wsl/repair-v22.5-docker-context.sh" ]; then
  "$ROOT_DIR/scripts/wsl/repair-v22.5-docker-context.sh" >/dev/null
fi
