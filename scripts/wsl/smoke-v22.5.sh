...
check_post "Release promote"           "/api/releases/rel-22.5-001/promote" '{"targetEnvironment":"local"}'
check_post "Release rollback"          "/api/releases/rel-22.5-001/rollback" '{"revision":"previous"}'
