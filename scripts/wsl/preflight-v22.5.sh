#!/usr/bin/env bash
# v23.1 — Static and semi-static verification before runtime start.
set -euo pipefail
source "$(dirname "${BASH_SOURCE[0]}")/lib/common.sh"
cd "$ROOT_DIR"

log_step "NebulaOps v23.1 static preflight"
...
bash "$ROOT_DIR/scripts/wsl/verify-v23.1-real-data-mode.sh"
bash "$ROOT_DIR/scripts/wsl/verify-v23.1-governance-real-data.sh"
bash "$ROOT_DIR/scripts/wsl/verify-v23.1-progressive-delivery-real-data.sh"
...
log_ok "NebulaOps v23.1 preflight completed"
