# NebulaOps v23.4 Release Notes

NebulaOps v23.4 is a runtime-stability, compact-UI and live-only operations release.

## Highlights

- Full release identifier alignment to `v23.4` / `23.4.0`.
- Docker image naming updated to the `nebulaops-v23-4-*` namespace.
...
- Re-ran live-only runtime verification and v23.4 static preflight.

## Docker/OpenLens Troubleshooting & Root Cause Upgrade

Added within v23.4 without changing the public release number.
...
- Added `scripts/wsl/smoke-extension-async-control-plane-v23.4.sh`.
