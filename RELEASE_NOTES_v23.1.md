# NebulaOps v23.1 Release Notes

## Objective
NebulaOps v23.1 focuses on turning the existing modules into operational consoles backed by runtime integrations only. The frontend remote modules do not render seeded, static or mock rows. Empty/error states explicitly show that the live source returned no data or that the dependency is unavailable.
