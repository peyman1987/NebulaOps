package dev.nebulaops.observability.config;
...
/**
 * v23.4 — Keycloak resource-server integration.
 *
...
public class KeycloakResourceServerConfig {
    ...
    /**
     * v23.4 local/Keycloak JWT bridge.
     *
    ...
    public JwtDecoder jwtDecoder(
            @Value("${jwt.secret:nebulaops-v23-4-dev-secret-key-min-32-chars!!}") String jwtSecret,
