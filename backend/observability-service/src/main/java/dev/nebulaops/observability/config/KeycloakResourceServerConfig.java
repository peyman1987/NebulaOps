...
/**
 * v22.5 — Keycloak resource-server integration.
 *
...
public class KeycloakResourceServerConfig {
    ...
    /**
     * v22.5 local/Keycloak JWT bridge.
     *
    ...
    public JwtDecoder jwtDecoder(
            @Value("${jwt.secret:nebulaops-v22-5-dev-secret-key-min-32-chars!!}") String jwtSecret,
