...
/**
 * v23.1 — Keycloak resource-server integration.
 *
...
public class KeycloakResourceServerConfig {
    ...
    /**
     * v23.1 local/Keycloak JWT bridge.
     *
    ...
    public JwtDecoder jwtDecoder(
            @Value("${jwt.secret:nebulaops-v23-1-dev-secret-key-min-32-chars!!}") String jwtSecret,
