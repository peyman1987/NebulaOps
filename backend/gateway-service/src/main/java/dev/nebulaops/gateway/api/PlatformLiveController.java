...
public class PlatformLiveController {
    ...
    private List<String> commits() {
        ...
        if (log.isBlank())
            return List.of("feat(v20.3): dynamic platform telemetry", "style(ui): glassmorphism console refresh", "backend: live DevSecOps endpoints", "go: runtime services ready");
