...
/**
 * NebulaOps v23.2 — compact runtime diagnostics with real tool output only.
 */
@RestController
public class RuntimeDiagnosticsController {
    ...
    public Map<String, Object> diagnostics() {
        ...
        checks.put("extensionRegistry", probe("extensionRegistry", "command -v docker >/dev/null 2>&1 && (docker ps --format '{{.Names}}' | grep -qx nebulaops-v23-2-registry)", 4));
