...
/**
 * v23.2 — Operational excellence APIs.
 *
...
public class OperationalExcellenceController {
    ...
    public Map<String, Object> quality() {
        ...
        out.put("items", items);
        out.put("summary", summary(items));
        out.put("recommendedCommand", "./scripts/wsl/preflight-v23.2.sh");
        return out;
    }
    ...
    public Map<String, Object> qualityPreflight() {
        List<Map<String, Object>> items = List.of(
                ...
                fileRow("v23.2-preflight-script", "scripts/wsl/preflight-v23.2.sh", true),
    ...
    private List<Map<String, Object>> qualityReportRows() {
        ...
        rows.add(fileRow("preflight-v23.2", "scripts/wsl/preflight-v23.2.sh", true));
        rows.add(fileRow("presentation-live-data-audit", "V23.2_PRESENTATION_LIVE_DATA_AUDIT_REPORT.md", true));
