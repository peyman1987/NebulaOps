...
/**
 * v24.1 — Operational excellence APIs.
 *
...
public class OperationalExcellenceController {
    ...
    public Map<String, Object> quality() {
        ...
        out.put("items", items);
        out.put("summary", summary(items));
        out.put("recommendedCommand", "./scripts/wsl/preflight-v24.1.sh");
        return out;
    }
    ...
    public Map<String, Object> qualityPreflight() {
        List<Map<String, Object>> items = List.of(
                ...
                fileRow("v24.1-preflight-script", "scripts/wsl/preflight-v24.1.sh", true),
    ...
    private List<Map<String, Object>> qualityReportRows() {
        ...
        rows.add(fileRow("preflight-v24.1", "scripts/wsl/preflight-v24.1.sh", true));
        rows.add(fileRow("presentation-live-data-audit", "V24.1_PRESENTATION_LIVE_DATA_AUDIT_REPORT.md", true));
