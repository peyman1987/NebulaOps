...
| Field     | Value                              |
|-----------|------------------------------------|
| Project   | NebulaOps v20.6                    |
| Developer | Peyman Eshghi Malayeri             |
| Email     | peyman_em@yahoo.com                |
| Year      | 2024                               |
| Edition   | Professional DevOps Control Center |

NebulaOps v20.6 is a local-first platform engineering project for WSL/Linux execution. It demonstrates microservices,
...
Versione documentale corrente: **v20.6**.
...
- SVG v20.6 in `docs/diagrams` e `frontend/src/assets`
...
release_patch: v20.6-containers-openlens-refresh
features_added:
...
## v20.6 Dynamic Runtime Patch

- release_patch: v20.6-live-runtime-services
