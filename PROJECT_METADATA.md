...
| Field     | Value                              |
|-----------|------------------------------------|
| Project   | NebulaOps v19.5                    |
| Developer | Peyman Eshghi Malayeri             |
| Email     | peyman_em@yahoo.com                |
| Year      | 2024                               |
| Edition   | Professional DevOps Control Center |

NebulaOps v19.5 is a local-first platform engineering project for WSL/Linux execution. It demonstrates microservices,
...
Versione documentale corrente: **v19.5**.
...
- SVG v19.5 in `docs/diagrams` e `frontend/src/assets`
...
release_patch: v19.5-containers-openlens-refresh
features_added:
