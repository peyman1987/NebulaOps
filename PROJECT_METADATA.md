...
| Field     | Value                              |
|-----------|------------------------------------|
| Project   | NebulaOps v21.1                    |
| Developer | Peyman Eshghi Malayeri             |
| Email     | peyman_em@yahoo.com                |
| Year      | 2024                               |
| Edition   | Professional DevOps Control Center |

NebulaOps v21.1 is a local-first platform engineering project for WSL/Linux execution. It demonstrates microservices,
...
Versione documentale corrente: **v21.1**.
...
- SVG v21.1 in `docs/diagrams` e `frontend/src/assets`
...
release_patch: v21.1-containers-openlens-refresh
features_added:
...
## v21.1 Dynamic Runtime Patch

- release_patch: v21.1-live-runtime-services
