...
| Field     | Value                              |
|-----------|------------------------------------|
| Project   | NebulaOps v20.2                    |
| Developer | Peyman Eshghi Malayeri             |
| Email     | peyman_em@yahoo.com                |
| Year      | 2024                               |
| Edition   | Professional DevOps Control Center |

NebulaOps v20.2 is a local-first platform engineering project for WSL/Linux execution. It demonstrates microservices,
...
Versione documentale corrente: **v20.2**.
...
- SVG v20.2 in `docs/diagrams` e `frontend/src/assets`
...
release_patch: v20.2-containers-openlens-refresh
features_added:
...
## v20.2 Dynamic Runtime Patch

- release_patch: v20.2-live-runtime-services
