# Kubernetes deployment — apiforge

This folder contains the extension-local Kubernetes manifest for `apiforge`.
...
```bash
kubectl apply -f extensions/apiforge/k8s/deployment.yml
```
