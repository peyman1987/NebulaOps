<#--
  NebulaOps v23.2 — Keycloak Custom Login Template
...
<head>
  ...
  <title>NebulaOps v23.2 · Sign In</title>
...
<body>
  <main class="nb-card" role="main">
    ...
    <div class="nb-brand">
      <div class="nb-logo" aria-hidden="true">N23.2</div>
      <div>
        <div class="nb-brand-eyebrow">Terraform-enabled SaaS cockpit</div>
        <div class="nb-brand-name">NebulaOps v23.2</div>
      </div>
    </div>
    ...
    <div class="nb-footer">DevOps Enterprise Cockpit &middot; v23.2 &middot; Local-first</div>
  </main>
</body>
</html>
