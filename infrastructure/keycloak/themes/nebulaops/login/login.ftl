<#--
  NebulaOps v22.4 — Keycloak Custom Login Template
...
<head>
  ...
  <title>NebulaOps v22.4 · Sign In</title>
...
<body>
  <main class="nb-card" role="main">
    ...
    <div class="nb-brand">
      <div class="nb-logo" aria-hidden="true">N22.4</div>
      <div>
        <div class="nb-brand-eyebrow">Terraform-enabled SaaS cockpit</div>
        <div class="nb-brand-name">NebulaOps v22.4</div>
      </div>
    </div>
    ...
    <div class="nb-footer">DevOps Enterprise Cockpit &middot; v22.4 &middot; Local-first</div>
  </main>
</body>
</html>
